...
class NanoNQ_ragsolutedRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="NanoNQ_ragsolutedRetrieval",
        ...
        dataset={
            "path": "yjoonjang/nanonq_ragsoluted",
    ...
    def load_data(self, **kwargs):
        ...
        self.corpus = load_dataset(
            ...
            "corpus",
            revision="aa61808584ec61695ff88215a6b94294d94591cd",
        )
