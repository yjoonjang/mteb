...
class KoFSSFinDictRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="KoFSSFinDictRetrieval",
        description="This dataset is constructed for retrieval tasks based on the financial dictionary provided by the Korean Financial Supervisory Service (FSS). It enables the evaluation of Korean RAG performance in the financial domain by providing publicly accessible financial terms, queries, and answers.",
        reference="https://arxiv.org/pdf/2502.07131",
        dataset={
            "path": "nmixx-fin/twice_fss_dict_retrieval",
            "revision": "56e256c71095d969c07569de60117e2d2f86885f",
        },
        type="Retrieval",
